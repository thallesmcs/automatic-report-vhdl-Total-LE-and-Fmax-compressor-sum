----------------------------------------------------------------------------------
-- Top-level wrapper para o somador de 7 entradas e 8 bits do Vitis HLS.
----------------------------------------------------------------------------------

library IEEE;
use IEEE.STD_LOGIC_1164.ALL;

entity top_level_somador7_8bits is
  port (
    clk       : in  std_logic;
    ap_rst    : in  std_logic;
...
end top_level_somador7_8bits;

architecture Behavioral of top_level_somador7_8bits is
